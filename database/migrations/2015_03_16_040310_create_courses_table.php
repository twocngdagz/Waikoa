...
class CreateCoursesTable extends Migration {
	...
	public function up()
	{
		Schema::create('courses', function(Blueprint $table)
		{
			...
			$table->string('student_name_pl', 100);
			$table->string('instructor_name');
			$table->string('materials_name', 100);
			$table->string('materials_name_pl', 100);
			$table->string('events_name', 100);
			$table->string('events_name_pl', 100);
			$table->string('webinars_name', 100);
			$table->string('webinars_name_pl', 100);
